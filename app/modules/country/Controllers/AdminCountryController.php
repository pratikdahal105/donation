...
class AdminCountryController extends Controller
{
    ...
    {
        $page['title'] = 'Country';
        return view("country::index",compact('page'));
    ...
    public function getcountriesJson(Request $request)
    {
        ...
        // For pagination
        $filterTotal = $country->where( function($query) use ($where) {
            if($where !== null) {
        ...
        $rows = $country->where( function($query) use ($where) {
            if($where !== null) {
                foreach($where as $val) {
                    $query->orWhere($val[0],$val[1],$val[2]);
                }
    ...
    {
        $page['title'] = 'Country | Create';
        return view("country::add",compact('page'));
        //
    }
    ...
    public function edit($id)
    {
        ...
        return view("country::edit",compact('page','country'));
