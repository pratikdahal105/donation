...
@section('content')
    ...
    <div class="page-content container-fluid">
        <div class="page-header">
            <h1 class="page-title">Add Success_stories </h1>
            <ol class="breadcrumb">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <form role="form" action="{{ route('admin.success_stories.store') }}"  method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                    <label for="title">Title</label><input type="text" name="title" id="title" class="form-control" ></div><div class="form-group">
                                <label for="body">Body</label><textarea type="text" name="body" id="body" class="form-control" ></textarea></div><div class="form-group">
                                    <label for="by">By</label><input type="text" name="by" id="by" class="form-control" ></div><div class="form-group">
