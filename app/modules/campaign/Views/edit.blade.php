...
{{--                                    <label for="slug">Slug</label><input type="text" value = "{{$campaign->slug}}"  name="slug" id="slug" class="form-control" ></div><div class="form-group">--}}
                                <div class="form-group">
                                    ...
                                    <label for="location_id">Location_id</label><input type="number" value = "{{$campaign->location_id}}"  name="location_id" id="location_id" class="form-control" ></div><div class="form-group">
                                    <label for="thumbnail">Thumbnail (upload to replace current file)</label><input type="file" accept=".jpeg, .png, .jpg" value = "{{$campaign->thumbnail}}"  name="thumbnail" id="thumbnail" class="form-control" ></div><div class="form-group">
                                    ...
                                    <label for="logo">Logo (upload to replace current file)</label><input type="file" accept=".jpeg, .png, .jpg" value = "{{$campaign->logo}}"  name="logo" id="logo" class="form-control" ></div><div class="form-group">
