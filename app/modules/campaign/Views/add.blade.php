...
{{--                                    <label for="user_id">User_id</label><input type="text" name="user_id" id="user_id" class="form-control" ></div><div class="form-group">--}}
                                    ...
                                    <label for="location_id">Location_id</label><input type="number" name="location_id" id="location_id" class="form-control" ></div><div class="form-group">
                                    ...
                                    <label for="minimum_tip">Minimum_tip in %</label><input min="0" max="30" type="number" name="minimum_tip" id="minimum_tip" class="form-control" >
{{--                                </div><div class="form-group">--}}
