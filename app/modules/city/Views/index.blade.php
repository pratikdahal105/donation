    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table style="width: 100% !important" id="city-datatable" class="table table-hover dataTable table-striped">
                    <thead>
                        <tr>
                            <th>SN</th>
							<th >Name</th>
...
<script>
    ...
    $(function(){
        dataTable = $('#city-datatable').DataTable({
        dom: 'Bfrtip',
        "serverSide": true,
        buttons: [
        'copy', 'csv', 'excel', 'pdf', 'print'
        ],
        'ajax' : { url: "{{ route('admin.cities.getdatajson') }}",type: 'POST', data: {'_token': '{{ csrf_token() }}' } },
