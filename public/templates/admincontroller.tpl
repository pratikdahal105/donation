...
class {ADMIN_CONTROLLER_NAME_UCFIRST} extends Controller
{
    ...
    public function index()
    {
        ...
        return view("{MODULE_NAME}::index",compact('page'));
    ...
    public function create()
    {
        ...
        return view("{MODULE_NAME}::add",compact('page'));
        //
    }
    ...
    public function edit($id)
    {
        ...
        return view("{MODULE_NAME}::edit",compact('page','{MODEL_NAME}'));
    ...
    {
        $data = $request->except('_token');
        $success = {MODEL_NAME_UCFIRST}::where('id', $id)->update($data);
        return redirect()->route('admin.{MODULE}');
