    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table style="width: 100% !important" id="role-datatable" class="table table-hover dataTable table-striped">
                    <thead>
                        <tr>
                            <th>SN</th>
							<th >Name</th>
...
<script>
    ...
    $(function(){
        ...
        'ajax' : { url: "{{ route('admin.roles.getdatajson') }}",type: 'POST', data: {'_token': '{{ csrf_token() }}' } },
