    ...
    $(function(){
        ...
        'ajax' : { url: "{{ route('admin.campaigns.getdatajson') }}",type: 'POST', data: {'_token': '{{ csrf_token() }}' } },
            ...
            columns: [
                ...
                { data: "slug",name: "slug"},{ data: "category_id",name: "category_id"},{ data: "user_id",name: "user_id"},{ data: "campaign_name",name: "campaign_name"},{ data: "location_id",name: "location_id"},{ data: "thumbnail",name: "thumbnail"},{ data: "video_url",name: "video_url"},{ data: "body",name: "body"},{ data: "target_amount",name: "target_amount"},{ data: "created_for",name: "created_for"},{ data: "logo",name: "logo"},{ data: "publish_date",name: "publish_date"},{ data: "stop_limit",name: "stop_limit"},{ data: "status",name: "status"},{ data: "minimum_tip",name: "minimum_tip"},{ data: "search",name: "search"},{ data: "deleted_at",name: "deleted_at"},{ data: "created_at",name: "created_at"},{ data: "updated_at",name: "updated_at"},
